package org.nazuz.payroll.server;
 ...
 * org.eclipse.equinox.http.jetty.context.path=/payroll_server
 ...
 * eclipse.product=org.nazuz.payroll.server.product
 */
public class ServerApplication implements IApplication {
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    logger.info("payroll server initialized");
    return EXIT_OK;
  }
